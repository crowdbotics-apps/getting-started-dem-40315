"""
Django settings for getting_started_dem_40315 project.
...
ROOT_URLCONF = 'getting_started_dem_40315.urls'
...
WSGI_APPLICATION = 'getting_started_dem_40315.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "getting_started_dem_40315 API",
    "DESCRIPTION": "API documentation for getting_started_dem_40315 App",
    "VERSION": "v1",
}
