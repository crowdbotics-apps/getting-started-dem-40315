...
## Project Structure
    ...
    ├── getting_started_dem_40315  # Django project configurations
...
1. Clone this repo and `cd getting_started_dem_40315`
...
2. Clone this repo and `cd getting_started_dem_40315`
